...
import {UserChatRoom} from "../module/chat/user-chat-room.entity";
import {ChatRoom} from "../module/chat/chat.room.entity";
import {ChatMessage} from "../module/chat/chat.message.entity";
...
export const DbDatasource = new DataSource({
    ...
    entities: [User, Boards, Languages, NativeLanguages, WishLanguages, Invite, UserChatRoom, ChatRoom, ChatMessage],  // 엔티티를 명시적으로 지정하거나, glob 패턴을 사용하여 여러 엔티티를 포함 가능
