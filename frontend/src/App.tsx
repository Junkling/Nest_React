...
import ChatComponent_V3 from "./pages/chat/ChatComponent_V3";
import Profile from "./components/Profile";
import {AuthProvider} from "./auth/AuthContext"; // ChatComponent_V3 임포트
        ...
        <AuthProvider> {/* AuthProvider로 감싸기 */}
            <Router>
                <Routes>
                    ...
                    <Route path="/chat/room/:roomName/:userName"
                           element={<ChatComponent_V3Wrapper/>}/> {/* ChatComponent_V3 라우팅 */}
